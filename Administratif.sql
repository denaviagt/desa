...
--
-- Host: 127.0.0.1
-- Generation Time: 18 Jun 2020 pada 17.24
...
INSERT INTO `apartur_desa` (`id_aparatur`, `nama`, `jabatan`, `jkel`) VALUES
...
(344081305640003, 3404080802059634, 'SULISTYO', 'Laki-laki', '1957-05-09', 'Islam', 'S 1', 'PENSIUNAN', 'Menikah', 'Kepala'),
...
--
ALTER TABLE `apartur_desa`
  MODIFY `id_aparatur` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
